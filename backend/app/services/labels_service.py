...
BUILTIN_TEMPLATES = [
    ...
    {
        "name": "Grocery Scale & Perishable Label",
        "label_scope": "Product",
        "width_mm": 58,
        "height_mm": 40,
        "canvas": {
            ...
            "border": {"enabled": True, "color": "#111827", "width": 1},
            "elements": [
                {"id": "shop", "type": "text", "x": 2, "y": 2, "w": 54, "h": 4, "fontSize": 9, "bold": True, "value": "{{shop_name}}"},
                {"id": "name", "type": "text", "x": 2, "y": 6, "w": 54, "h": 6, "fontSize": 10, "bold": True, "value": "{{product_name}}"},
                {"id": "batch", "type": "text", "x": 2, "y": 12, "w": 26, "h": 4, "fontSize": 7, "value": "Batch: {{batch_number}}"},
                {"id": "expiry", "type": "text", "x": 29, "y": 12, "w": 27, "h": 4, "fontSize": 7, "value": "EXP: {{expiry_date}}"},
                {"id": "barcode", "type": "barcode", "x": 3, "y": 17, "w": 52, "h": 12, "fontSize": 8, "format": "EAN-13", "value": "{{barcode}}"},
                {"id": "price", "type": "price", "x": 2, "y": 30, "w": 54, "h": 7, "fontSize": 13, "bold": True, "value": "LKR {{price}}"},
            ],
        },
    },
    {
        "name": "Fashion Apparel Hangtag",
        "label_scope": "Product",
        "width_mm": 50,
        "height_mm": 70,
        "canvas": {
            ...
            "border": {"enabled": True, "color": "#111827", "width": 1},
            "elements": [
                {"id": "brand", "type": "text", "x": 2, "y": 4, "w": 46, "h": 6, "fontSize": 12, "bold": True, "value": "{{brand}}"},
                {"id": "name", "type": "text", "x": 2, "y": 11, "w": 46, "h": 8, "fontSize": 10, "bold": True, "value": "{{product_name}}"},
                {"id": "size_color", "type": "text", "x": 2, "y": 20, "w": 46, "h": 6, "fontSize": 9, "value": "Size: {{storage}} | Color: {{color}}"},
                {"id": "barcode", "type": "barcode", "x": 3, "y": 28, "w": 44, "h": 16, "fontSize": 8, "format": "CODE 128", "value": "{{barcode}}"},
                {"id": "price", "type": "price", "x": 2, "y": 48, "w": 46, "h": 8, "fontSize": 15, "bold": True, "value": "LKR {{price}}"},
                {"id": "care", "type": "text", "x": 2, "y": 58, "w": 46, "h": 8, "fontSize": 7, "value": "100% Cotton • Machine Wash Cold"},
            ],
        },
    },
    {
        "name": "Cosmetics Batch & Expiry Tag",
        "label_scope": "Product",
        "width_mm": 40,
        "height_mm": 25,
        "canvas": {
            ...
            "border": {"enabled": True, "color": "#111827", "width": 1},
            "elements": [
                {"id": "name", "type": "text", "x": 1, "y": 1, "w": 38, "h": 5, "fontSize": 8, "bold": True, "value": "{{product_name}}"},
                {"id": "batch", "type": "text", "x": 1, "y": 6, "w": 18, "h": 4, "fontSize": 6, "value": "B: {{batch_number}}"},
                {"id": "exp", "type": "text", "x": 20, "y": 6, "w": 19, "h": 4, "fontSize": 6, "value": "EXP: {{expiry_date}}"},
                {"id": "barcode", "type": "barcode", "x": 2, "y": 10, "w": 36, "h": 8, "fontSize": 6, "format": "CODE 128", "value": "{{barcode}}"},
                {"id": "price", "type": "price", "x": 1, "y": 19, "w": 38, "h": 4, "fontSize": 9, "bold": True, "value": "LKR {{price}}"},
            ],
        },
    },
    {
